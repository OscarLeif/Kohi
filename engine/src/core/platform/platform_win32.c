...
b8 platform_startup(
    ...
    // In this case, the border rectange is negative
...
void platform_console_write(const char *message, u8 colour) {
    ...
    static u8 levels[8] = {64, 4, 6, 2, 1, 8};
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    switch (msg) {
        case WM_ERASEBKGND:
            ...
            return 1;
        case WM_CLOSE:
            // TODO: Fire an event for the application for quit
            return 0;
        case WM_DESTROY:
            PostQuitMessage(0);
            return 0;
            case WM_SIZE:
            {
                ...
                // TODO: Fire and eventg for the window resize
            }break;
            case WM_KEYDOWN:
            case WM_SYSKEYDOWN:
            case WM_KEYUP:
